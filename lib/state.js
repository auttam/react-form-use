...
const getError = ({ value, validate }, state) => {
  ...
  // if validate callback function returns false
  return fieldError || (valid === false ? 'Invalid value' : '');
};
 ...
 * @returns {Boolean} return false to mark field as invalid
 */
 ...
 * @param {Array.<Options>} optionsList list of field options
 */
export const initialize = (optionsList) =>
 ...
 */
export const reducer = (state, { action, fieldName, data }) => {
